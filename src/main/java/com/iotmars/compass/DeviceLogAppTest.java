...
//        Table faultTable = tableEnv.sqlQuery("SELECT '***********************',*" +
//                        "FROM tmp_fault "
////                "GROUP BY productKey, iotId, deviceName, eventName, opt_id, opt_name "
//        );
//        tableEnv.toChangelogStream(faultTable).print();
//
//        Table ovModeTable = tableEnv.sqlQuery("SELECT '***********************',*" +
//                        "FROM tmp_ov_mode "
////                "GROUP BY productKey, iotId, deviceName, eventName, opt_id, opt_name "
//        );
//        tableEnv.toChangelogStream(ovModeTable).print();
//
//        Table stageTable = tableEnv.sqlQuery("SELECT '***********************',*" +
//                        "FROM tmp_multistage_name "
////                "GROUP BY productKey, iotId, deviceName, eventName, opt_id, opt_name "
//        );
//        tableEnv.toChangelogStream(stageTable).print();
